...
scheme = 'ProjectPackageTest'
config_name = 'Release'
path = './ProjectPackageTest'
path_project = '{}/ProjectPackageTest.xcodeproj'.format(path)
...
path_info_plist = '{}/ProjectPackageTest/Info.plist'.format(path)
...
for l in package.clean(path_project, scheme, True):
    print(l)
...
for l in package.package_archive(path_project, scheme, config_name, path_archive, True):
    print(l)
